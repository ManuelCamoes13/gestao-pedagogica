<template>
  <div class="tables-basic">
    <b-row>
      <b-col>
    <h2 class="page-title"><span class="fw-semi-bold">Curso</span></h2>
    </b-col>
    <b-col>
      <div class="d-flex">
    ...
    <b-form-input placeholder="Procurar" size="sm" @input="search" />
                ...
                <tr v-for="curso in cursos"
                 :key="curso.id">
                  ...
                  <td class="width-200">
                    ...
                    <b-button @click="deleteData(curso)" class="ml-3" variant="danger">
     ...
     <b-modal ref="novo" id="novo" size="md" body-class="bg-white"  title="Novo Curso"  hide-footer>
      ...
      <b-col md="12" cols="12" xs="12">
            ...
            >
              <v-select name="curso" :options="coordenadores" v-model="selectedCoordenador" label="nome">
      ...
      <b-form @submit.prevent="">
       ...
       <b-col md="12" cols="12" xs="12">
            <b-form-group
              ...
              label-for="Coordenador"
            >
              <v-select name="curso" :options="coordenadores" v-model="selectedCoordenador" label="name">
...
export default {
 ...
 saveData() {
      ...
      const data = {
         ...
         coordenador:this.selectedCoordenador.id,
         
      }
      setTimeout(function () {
      }, 1000);
      http
        .post("/curso",data, config)
        .then((success) => {
          success;
          this.$refs["novo"].hide();
          this.getData();
