<template>
  <div class="d-flex flex-column">
      ...
      <!-- <i class="info-icon la la-ellipsis-v d-none d-xl-inline-block"></i> -->
          <b-dropdown
                    ...
                    >
                      ...
                      <b-dropdown-item to="/app/client/individual/detail"
                        ><i class="fa fa-money text-primary"></i>
                        Efectuar Pagamento</b-dropdown-item
                      >
                      <b-dropdown-item to="/app/client/individual/detail" v-b-modal.associar
                        ><i class="fa fa-user text-primary"></i> Ver Perfil</b-dropdown-item
                      >
                    </b-dropdown>
    ...
    <form class="chat-section new-message mb-0 mx-0" @submit="sendMessage($event)">
      ...
      <b-input v-model="newMessage" placeholder="Envie uma mensagem"></b-input>
